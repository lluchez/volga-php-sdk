...
function P7_PMhide(u){ //v1.0 by PVII-www.projectseven.com
 var i,tt,ua;u.p7pmax=0;u.className="p7PMhide";ua=u.parentNode.firstChild;if(ua.nodeName == "#text"){ua = ua.nextSibling;}if(ua && ua.className.match(/p7PMon/)){ua.className=ua.className.replace("p7PMon","p7PMtrg");}
}
function P7_PMtg(a){ //v532 alpha by PVII-www.projectseven.com
 var i,u,tA,tU,pp;tA=p7PMct[a];pp=tA.parentNode;while(pp){if(pp.tagName=="UL"){break;}pp=pp.parentNode;}if(pp){
 tU=pp.getElementsByTagName("UL");for(i=tU.length-1;i>-1;i--){if(tA.p7PMsub==tU[i]){continue;}else{P7_PMhide(tU[i]);}}}
}
